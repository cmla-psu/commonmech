...
def run_experiment(args, dataset, B1, S1, B2, S2):
    ...
    print("algo1 correct: ", algo1_count, "ratio: ", algo1_count / total_count)
    print("algo2 correct: ", algo2_count, "ratio: ", algo2_count / total_count)
    print("base correct: ", base_count, "ratio: ", base_count / total_count)
    print("com correct: ", com_count, "ratio: ", com_count / total_count)

    print("PLB: ", plb, "PLB com: ", plb_com, "Common PLB Ratio: ", plb_com/plb)
    print("PLB saved: ", plb_saved, "Saved PLB Ratio: ", plb_ratio)
